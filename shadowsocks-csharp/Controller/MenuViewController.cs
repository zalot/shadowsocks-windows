...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private void ShowVPNList()
        {
            if (vpnListForm != null)
            {
                vpnListForm.Activate();
            }
            else
            {
                vpnListForm = new VPNRunner(controller);
                vpnListForm.Show();
                vpnListForm.Activate();
                vpnListForm.FormClosed += configForm_FormClosed;
            }
        }
